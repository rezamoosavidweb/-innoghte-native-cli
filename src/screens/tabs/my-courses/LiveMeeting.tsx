...
import { fetchLiveMeetingFake } from '@/lib/@fake-db/live-meeting';
...
export default function LiveMeeting() {
  const { data, isFetching } = useQuery({
    queryFn: async () => {
      const res = await fetchLiveMeetingFake();
      return res;
    },
  ...
  if (isFetching)
    return (
      <Text style={{ fontSize: FONT_SIZES.xxl }}>Loading live meeting ...</Text>
    );
            ...
            >
              <View style={styles.cardContent}>
                ...
                {/* <CardRow
                  ...
                  value={el?.included_courses_count}
                /> */}
                <CardRow
                  icon={<CoinsIcon />}
                  title="price"
