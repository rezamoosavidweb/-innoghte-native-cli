...
// import { toggleLanguage } from '@/translations/utils';
      ...
      <ScrollView>
        ...
        <View style={[gutters.paddingHorizontal_32, gutters.marginTop_40]}>
          ...
          >
            ...
            >
              <IconByVariant path="theme" stroke={colors.red500} />
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() => {
                setLanguage(SupportedLanguages.FA_IR);
              }}
              style={[components.buttonCircle, gutters.marginBottom_16]}
              testID="change-language-fa-button"
            >
            ...
            <TouchableOpacity
              ...
              style={[components.buttonCircle, gutters.marginBottom_16]}
              testID="change-language-en-button"
            >
              <IconByVariant path="language" stroke={colors.purple500} />
            </TouchableOpacity>
          </View>
